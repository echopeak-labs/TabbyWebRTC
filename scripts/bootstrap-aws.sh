...
After bootstrap, create the GitHub Actions deploy role:
  GITHUB_ORG=your-org yarn deploy:iam
...
cd "$ROOT/components/infra" && yarn cdk bootstrap "aws://$AWS_ACCOUNT/$AWS_REGION"

echo ""
echo "CDK bootstrap complete."
echo "Next: GITHUB_ORG=your-org yarn deploy:iam"
